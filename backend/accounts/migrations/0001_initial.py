    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('battery_capacity', models.DecimalField(decimal_places=2, max_digits=8, verbose_name='电池容量(度)')),
                ('vehicle_model', models.CharField(blank=True, max_length=100, verbose_name='车辆型号')),
