      ...
      <div className="px-4 py-6 sm:px-0">
        <div className="mb-8 flex justify-between items-center">
          <div>
            ...
            <p className="mt-2 text-gray-600">管理您的车辆信息</p>
          </div>
          ...
          <CardContent>
            {vehicles.length === 0 ? (
              <div className="text-center py-8">
                ...
                <h3 className="mt-2 text-sm font-medium text-gray-900">暂无车辆</h3>
                <p className="mt-1 text-sm text-gray-500">开始添加您的第一辆车</p>
                <div className="mt-6">
