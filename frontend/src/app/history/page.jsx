          ...
          >
            <motion.div variants={itemVariants}>
              ...
              <CardContent>
                  ...
                  >
                    <AnimatedNumber value={summary.total_sessions} />
                  </motion.div>
                <p className="text-xs text-muted-foreground">
                    近30天：<AnimatedNumber value={summary.recent_sessions} />次
                </p>
              </CardContent>
            </Card>
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                    平均每次：<AnimatedNumber 
                      value={summary.summary.total_amount / Math.max(summary.total_sessions, 1)} 
                      precision={1}
                    /> kWh
                </p>
              </CardContent>
            ...
            <motion.div variants={itemVariants}>
              ...
              <CardContent>
                  ...
                  >
                    ¥<AnimatedNumber 
                      value={summary.summary.total_cost} 
                      precision={2}
                    />
                  </motion.div>
                <p className="text-xs text-muted-foreground">
                    平均每次：¥<AnimatedNumber 
                      value={summary.summary.avg_cost_per_session} 
                      precision={2}
                    />
                </p>
              </CardContent>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              <AnimatedNumber value={stats.total_amount} precision={1} /> kWh
            </div>
            <p className="text-xs text-muted-foreground">
              平均每次：<AnimatedNumber value={stats.avg_amount} precision={1} /> kWh
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              ¥<AnimatedNumber value={stats.total_cost} precision={2} />
            </div>
            <p className="text-xs text-muted-foreground">
              平均每次：¥<AnimatedNumber value={stats.avg_cost} precision={2} />
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              <AnimatedNumber value={stats.total_duration} precision={1} />h
            </div>
            <p className="text-xs text-muted-foreground">
              平均每次：<AnimatedNumber value={stats.avg_duration} precision={1} />h
            </p>
          </CardContent>
        </Card>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span>峰时电费</span>
                <span>
                  ¥<AnimatedNumber value={stats.cost_analysis.peak_cost} precision={2} /> 
                  (<AnimatedPercentage value={stats.cost_analysis.peak_percentage} precision={1} />)
                </span>
              </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span>平时电费</span>
                <span>
                  ¥<AnimatedNumber value={stats.cost_analysis.normal_cost} precision={2} /> 
                  (<AnimatedPercentage value={stats.cost_analysis.normal_percentage} precision={1} />)
                </span>
              </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span>谷时电费</span>
                <span>
                  ¥<AnimatedNumber value={stats.cost_analysis.valley_cost} precision={2} /> 
                  (<AnimatedPercentage value={stats.cost_analysis.valley_percentage} precision={1} />)
                </span>
              </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span>服务费</span>
                <span>
                  ¥<AnimatedNumber value={stats.cost_analysis.service_cost} precision={2} /> 
                  (<AnimatedPercentage value={stats.cost_analysis.service_percentage} precision={1} />)
                </span>
              </div>
              ...
              {stats.favorite_piles.map((pile, index) => (
                <div key={pile.pile_id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800/50 rounded">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">
                    使用<AnimatedNumber value={pile.usage_count} />次 · <AnimatedNumber value={pile.total_amount} precision={1} />kWh
                  </div>
                </div>
              ))}
            </div>
